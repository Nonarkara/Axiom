...
const ARCHITECTURES = {
  ...
  'nst': {
    ...
    ver: '1.0.0',
    idx: '37',
    inputs: ['3D city mesh', 'Satellite', 'Flood / basin feeds', 'Khao Luang', 'Pak Phanang', '30+ live sources'],
    core: { name: 'NST-01', meta: ['municipal IOC', 'Nakhon Si Thammarat'] },
    outputs: ['City command view', 'Flood watch', 'Basin situation'],
    foot: 'civic intelligence · southern Thailand coast',
  },
  'podcast-20min': {
    name: '20 MIN WITH DR NON',
    ver: '0.1.0',
    idx: '38',
    inputs: ['Field notes', 'City systems', 'AI agents', 'Geopolitics'],
    core: { name: 'PODCAST', meta: ['emerging', 'Spotify'] },
    outputs: ['Episode drops', 'Signal briefs', 'Open questions'],
    foot: 'twenty minutes · ideas that create the next move',
  },
  'omniarcade': {
    name: 'OMNIARCADE',
    ver: '1.0.0',
    idx: '39',
    inputs: ['Research trainers', 'Classic carts', 'Brain briefings', 'Local scores'],
    core: { name: 'OMNIARCADE', meta: ['16-bit floor', 'honest practice'] },
  ...
  'geo': {
    ...
    ver: '6.0.0',
    idx: '42',
    inputs: ['Myanmar frontier', 'Cambodia frontier', 'Southern theatre', 'Open feeds'],
    core: { name: 'GEO WATCH', meta: ['tri-border', 'live + playback'] },
    outputs: ['Border posture', 'Operations map', 'News wire', 'Time machine'],
    foot: 'Thailand · three frontiers · one command surface',
    stack: ['Next.js', 'MapLibre', 'Cloudflare'],
  },
};
...
function injectSystemArchitectures() {
  return; // Disabled: black architecture boxes removed per design review
}
...
const uiCopy = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Your city already has the data — scattered across agencies, so no one sees the whole picture when it matters. We turn it into one live screen for the decision you can\'t afford to get wrong. Working in two weeks, not after the next budget cycle.',
    ...
    navCurrent: {
      why: 'How It Works', systems: 'Systems', stages: 'Stages', team: 'Team', press: 'Press', brand: 'Brand Kit', credentials: 'Credentials', cta: 'Work With Us',
    },
    heroCurrent: {
    ...
    ctaSect: {
      ...
      title: 'Tell us the decision. <em>We\'ll show it working in two weeks.</em>',
      body: 'Write one paragraph: the decision you need to make faster, who makes it, and where the data sits today. You\'ll get a clear yes, a clear no, or one sharper question back. No sales deck. No procurement warm-up.',
      promise1: 'Week 1 — the decision, the people and the data agreed on one page.',
      promise2: 'Week 2 — a working pilot on your existing and free public data. No new hardware to start.',
      promise3: 'From day one — every use and decision logged, so you scale only what is proven.',
      alt: 'Or find us on',
    },
  },
  ...
  th: {
    ...
    hero: {
      ...
      titleLine1: 'นวัตกรรม',
      subtitle: 'เมืองของคุณมีข้อมูลอยู่แล้ว แต่กระจายอยู่ตามหน่วยงานต่าง ๆ จึงไม่มีใครเห็นภาพรวมในวินาทีที่สำคัญ ผมเปลี่ยนข้อมูลนั้นให้เป็นหน้าจอสดหน้าเดียว สำหรับการตัดสินใจที่คุณพลาดไม่ได้ ใช้งานได้ภายในสองสัปดาห์ ไม่ต้องรอรอบงบประมาณหน้า',
      cta: 'เริ่มพิสูจน์ใน 2 สัปดาห์',
      ctaSecondary: 'ลองใช้ระบบจริง',
    ...
    navCurrent: {
      why: 'วิธีการทำงาน', systems: 'ระบบ', stages: 'เวที', team: 'ทีม', press: 'สื่อ', brand: 'แบรนด์คิต', credentials: 'หนังสือรับรอง', cta: 'เริ่มงานร่วมกัน',
    },
    heroCurrent: {
    ...
    sysSect: {
      ...
      lede: 'หลักฐาน ไม่ใช่คำสัญญา ทุกระบบด้านล่างเริ่มจากการตัดสินใจหนึ่งเรื่องที่มีคนทำได้ไม่ทันการณ์ และทุกระบบใช้งานได้จริงวันนี้ — เปิดเข้าไป ลองใช้ แล้วตัดสินผลงานด้วยตัวคุณเอง',
      sandboxKicker: 'Sandbox // Live',
    ...
    ctaSect: {
      ...
      title: 'บอกผมว่าคุณต้องตัดสินใจเรื่องอะไร <em>ผมจะทำให้เห็นว่ามันใช้งานได้ภายในสองสัปดาห์</em>',
      body: 'เขียนมาหนึ่งย่อหน้า: การตัดสินใจที่ต้องทำให้เร็วขึ้น ใครเป็นผู้ตัดสินใจ และตอนนี้ข้อมูลอยู่ที่ไหน คุณจะได้คำตอบที่ชัดเจนว่าใช่ ไม่ใช่ หรือคำถามที่คมขึ้นหนึ่งข้อ ไม่มีสไลด์ขายของ ไม่มีการวอร์มอัพรอบจัดซื้อ',
      promise1: 'สัปดาห์ที่ 1 — ตกลงเรื่องการตัดสินใจ คน และข้อมูล ให้จบในหน้าเดียว',
      promise2: 'สัปดาห์ที่ 2 — ระบบนำร่องที่ใช้งานได้จริง บนข้อมูลที่มีอยู่และข้อมูลสาธารณะฟรี เริ่มต้นโดยไม่ต้องซื้อฮาร์ดแวร์ใหม่',
      promise3: 'ตั้งแต่วันแรก — บันทึกทุกการใช้งานและทุกการตัดสินใจ เพื่อขยายเฉพาะสิ่งที่พิสูจน์แล้ว',
      alt: 'หรือหาผมได้ที่',
    },
  },
  ...
  zh: {
    ...
    hero: {
      badge: '所有系统在线',
      titleLine1: '创新',
      subtitle: '你的城市早已拥有数据——只是散落在各个部门，关键时刻没有人看得到全局。我们把它变成一块实时屏幕，服务于你不能出错的那一个决策。两周内上线运行，而不是等到下一个预算周期。',
      cta: '开始两周验证',
      ctaSecondary: '试用在线系统',
      nodeLabel: '点选战区',
    ...
    navCurrent: {
      why: '运作方式', systems: '系统', stages: '舞台', team: '团队', press: '媒体', brand: '品牌套件', credentials: '资质', cta: '开始合作',
    },
    heroCurrent: {
    ...
    sysSect: {
      ...
      lede: '用证据说话，而不是承诺。下面每个系统都始于一个“做得不够快”的决策。每一个今天都在线运行——打开它、使用它、自己评判。',
      sandboxKicker: 'Sandbox // Live',
    ...
    ctaSect: {
      kicker: '一起来做',
      meta: '曼谷 · 东南亚',
      title: '告诉我们那个决策。<em>两周内让你看到它跑起来。</em>',
      body: '写一段话：你需要更快做出的决策、由谁决定、数据目前在哪里。你会得到一个明确的“可以”、一个明确的“不行”，或一个更尖锐的问题。没有销售演示稿，没有采购热身。',
      promise1: '第 1 周——决策、相关人员和数据在一页纸上达成一致。',
      promise2: '第 2 周——基于现有数据和免费公共数据的可用试点。起步无需新硬件。',
      promise3: '从第一天起——记录每一次使用和每一个决策，只扩展被证明有效的部分。',
      alt: '或者在这里找我们',
    },
  },
  ...
  ts: {
    ...
    hero: {
      badge: '// status: ONLINE',
      titleLine1: 'Innovation',
      subtitle: '// your city already has the data — scattered across agencies\nconst screen = oneLiveScreen(decision, { within: "2w", notAfter: "nextBudgetCycle" })',
      cta: 'proof.start({ weeks: 2 })',
      ctaSecondary: 'systems.tryLive()',
    ...
    sysSect: {
      ...
      lede: '// proof, not promises\n// each: oneDecision → liveSystem → you.judge()',
      sandboxKicker: '// SANDBOX // LIVE',
    ...
    ctaSect: {
      kicker: '// WORK_WITH_US',
      meta: '// bkk · SEA',
      title: 'decision.send() // we.will.show(working, { within: "2w" })',
      body: 'brief = paragraph({ decision, owner, dataLocation })\nreply: yes | no | sharperQuestion\n// no salesDeck() · no procurementWarmup()',
      promise1: 'week(1): agree({ decision, people, data }) // onePage',
      promise2: 'week(2): pilot(existingData + freePublicData) // newHardware: 0',
      promise3: 'day(1): log(use + decisions) → scale(only: proven)',
      alt: '// or find us on',
    },
  },
};
...
const i18nExt = {
  en: {
    panels: {
      ...
      p48: {
        name: 'FLOODDASH (Thailand Flood Watch)',
        lede: 'A real-time, openly-sourced flood watch built so every Thai province can read the same situation picture from official public data. Streams 9 public sources every 3–60 minutes.',
        cta: 'Open live system',
      },
      p49: {
        name: 'Sikhio Town Operations',
        lede: 'A live command surface tracking the Sikhio Town Municipality — integrating AQI, weather, traffic patterns, and live city data to aid municipal decision-making.',
        cta: 'Open live system',
      },
      p50: {
        lede: 'Real-time civic intelligence for Nakhon Si Thammarat City Municipality — 3D city, satellite, flood watch, Khao Luang & Pak Phanang basin. 30+ live data feeds.',
        cta: 'Open live system',
      },
      p51: {
      ...
      p52: {
        name: '20 Minutes with Dr Non',
        lede: 'Emerging podcast — ideas, agents, geopolitics, and the next twenty minutes. Live on Spotify; more episodes shipping.',
        cta: 'Open on Spotify',
      },
      p53: {
        name: 'ASCN Performance Review (Director\'s Cut)',
        lede: "A comprehensive insights dashboard into the ASEAN Smart Cities Network's performance across 134 projects and 38 cities — examining portfolio momentum and focus area shifts over four M&E cycles.",
        cta: 'Open live system',
      },
      p54: {
  ...
  th: {
    panels: {
      ...
      p48: {
        name: 'FLOODDASH (ระบบเฝ้าระวังน้ำท่วมไทย)',
        lede: 'ระบบเฝ้าระวังน้ำท่วมแบบเปิดและเรียลไทม์ ให้ทุกจังหวัดในไทยอ่านภาพสถานการณ์เดียวกันจากข้อมูลสาธารณะของหน่วยงานรัฐ ดึงข้อมูลจาก 9 แหล่งทุก 3-60 นาที',
        cta: 'เปิดระบบสด',
      },
      p49: {
        name: 'ปฏิบัติการเทศบาลสีคิ้ว',
        lede: 'หน้าจอบัญชาการสดสำหรับเทศบาลเมืองสีคิ้ว — บูรณาการ AQI สภาพอากาศ รูปแบบจราจร และข้อมูลเมืองสด เพื่อช่วยการตัดสินใจของเทศบาล',
        cta: 'เปิดระบบสด',
      },
      p50: {
        lede: 'ข่าวกรองพลเมืองเรียลไทม์สำหรับเทศบาลนครนครศรีธรรมราช — เมือง 3 มิติ ดาวเทียม เฝ้าระวังน้ำท่วม ลุ่มน้ำเขาหลวงและปากพนัง แหล่งข้อมูลสด 30+ แหล่ง',
        cta: 'เปิดระบบสด',
      },
      p51: {
        name: 'ปฏิบัติการแหลมฉบัง',
        lede: 'หน้าจอบัญชาการสดเฝ้าระวังการจราจรรถบรรทุกและการปฏิบัติตามกฎระเบียบทั่วเมืองแหลมฉบัง ออกแบบมาเพื่อประสานการจราจรท่าเรือ ลดความแออัด และรักษาความปลอดภัยในเมือง',
        cta: 'เปิดระบบสด',
      },
      p52: {
        name: '20 นาทีกับ ดร.นน',
        lede: 'พอดแคสต์ตัวใหม่ — ไอเดีย เอเจนต์ ภูมิรัฐศาสตร์ และยี่สิบนาทีถัดไป ออกอากาศสดบน Spotify ตอนใหม่กำลังตามมา',
        cta: 'เปิดใน Spotify',
      },
      p53: {
        name: 'ทบทวนผลงาน ASCN (ฉบับผู้อำนวยการ)',
        lede: 'แดชบอร์ดข้อมูลเชิงลึกที่ครอบคลุมเกี่ยวกับผลงานของเครือข่ายเมืองอัจฉริยะอาเซียนใน 134 โครงการ 38 เมือง — ตรวจสอบโมเมนตัมของผลงานและการเปลี่ยนแปลงด้านโฟกัสใน 4 รอบ M&E',
        cta: 'เปิดระบบสด',
      },
      p54: {
  ...
  zh: {
    panels: {
      ...
      p48: {
        name: 'FLOODDASH（泰国洪水监测）',
        lede: '一个实时、开放源代码的洪水监测系统，让泰国每个府都能从官方公开数据读出相同的态势图。每3-60分钟从9个公共数据源拉取一次。',
        cta: '打开在线系统',
      },
      p49: {
        name: '色吉奥市运行',
        lede: '追踪色吉奥市政府的实时指挥界面——整合空气质量、天气、交通模式与城市实时数据，辅助市政决策。',
        cta: '打开在线系统',
      },
      p50: {
        lede: '那空是塔玛叻市政府的实时民情情报——三维城市、卫星、洪水监测、考良与巴帕南流域。30+实时数据源。',
        cta: '打开在线系统',
      },
      p51: {
        name: '林查班运行',
        lede: '监测林查班市卡车交通与法规合规的实时指挥界面。用于协调港口交通、缓解拥堵、保障城市安全。',
        cta: '打开在线系统',
      },
      p52: {
        name: '与阿南博士的二十分钟',
        lede: '一档新播客——想法、代理、地缘政治，与下一个二十分钟。已在Spotify上线，更多剧集陆续发布。',
        cta: '在Spotify打开',
      },
      p53: {
        name: 'ASCN绩效评估（导演剪辑版）',
        lede: '一个关于东盟智慧城市网络在134个项目和38座城市表现的全面洞察仪表板——考察四个M&E周期内的项目势头与重点领域变化。',
        cta: '打开在线系统',
      },
      p54: {
  ...
  ts: {
    panels: {
      ...
      p48: { lede: '// floodDash.thailand.live()\n// 9 public.sources · streams.every(3-60min) // all 77 provinces · one.situation.picture', cta: 'system.open()' },
      p49: { lede: '// sikhio.municipality.surface()\n// AQI + weather + traffic + city.live.data // for: operators(who.actually.decide)', cta: 'system.open()' },
      p50: { lede: '// NST-01.nakhonSiThammarat()\n// 3D city + satellite + flood + KhaoLuang.basin + PakPhanang // 30+ live.sources', cta: 'system.open()' },
      p51: { lede: '// laemChabang.portTraffic()\n// truck.traffic + regulatory.compliance // coordinate.port + reduce.congestion', cta: 'system.open()' },
    ...
    teamContent: {
      ...
      probonoMeta:'projects: 5 · partners: institutional',
...
const i18nExt2 = {
  ...
  th: {
    chips: {
      ...
      p48:'สด · เฝ้าระวังน้ำท่วมชาติ',
      p49:'สด · ชีพจรเมือง',
      p50:'สด · ข่าวกรองนครศรีฯ',
      p51:'สด · จราจรท่าเรือ',
      p52:'สด · พอดแคสต์',
  ...
  ts: {
    chips: {
      ...
      p48:'live: NationalFloodWatch',
      p49:'live: CityPulse',
      p50:'live: NSTCivic',
      p51:'live: PortTraffic',
      p52:'live: Podcast',
    ...
    cats: {
      ...
      c37:'UrbanResearch',
      c38:'FieldworkBook',
      c39:'NationalProgramme',
      c40:'CityPulse',
      c41:'TrafficRegulation',
      c42:'DistrictOperations',
      c43:'Podcast',
...
// ── Pitch — the buyer's argument (#why section) ──────────────────────────
// Order is the argument: problem → how it works → results → objections.
// All 7 locales live together here so they stay in sync. Every number must
// match a live system on the page (38 in production · Phuket 30s · FloodDash
// 77 provinces / 9 sources · SLIC 157 cities / 45 min · field note 01).
const i18nPitch = {
  en: {
    pitch: {
      ...
      lede: 'You already own the data — rain gauges, traffic counts, air sensors, complaint lines, satellite passes. It sits in a dozen agencies and vendor portals. So when the crisis hits or the minister calls, you are the one in the room without the picture. That is the problem we fix: one live screen, for one decision, working in two weeks.',
      ...
      vsThem: 'A senior partner wins the deal. A junior team you never met does the work. The technical problem gets a slide deck, the timeline slips, and you end up managing the vendor instead of the city.',
      vsUsTitle: 'Axiom',
      vsUs: 'The people who pitch are the people who build. You talk to the architect, not a salesperson. We build whatever the problem needs, on your behalf — and you judge a working system, not a promise.',
      serviceLine: 'That is what we mean by Innovation as a Service: you bring the problem; we design, build and run the answer on your behalf.',
      howLabel: 'How it works · three steps',
      step1title: 'Week 1 — Name the decision.',
      step1body: 'We sit with the person who has to decide — a governor, a flood desk, a port authority. Together we pin down one decision that must get faster, who makes it, and which data already exists.',
      step2title: 'Week 2 — Put a working screen in the room.',
      step2body: 'We build on the data you already have plus free public sources. No new sensors or hardware to start. You judge a live system, not a mock-up, before anyone writes a presentation.',
      step3title: 'From day one — Measure, then scale.',
      step3body: 'Every screen records who uses it and which decisions it touched. You expand only what is proven to be used. Nothing is scaled on faith.',
      resultLabel: 'What changes · measured on live systems, not promised',
      r1lbl: 'Phuket Ops',
      r1: 'Transit, safety and environment on one screen a governor reads in 30 seconds.',
      r2lbl: 'FloodDash',
      r2: 'Every Thai province on one flood picture — 9 public sources, refreshed every 3–60 minutes.',
      r3lbl: 'SLIC Index · Taipei',
      ...
      q1: 'Is it expensive?',
      a1: 'The first step is deliberately small: a two-week proof on data you already own and free public sources, with no hardware to buy. You commit to a larger build only after you have seen the small one work.',
      q2: 'Will it work with our data?',
      a2: 'It already works with Thai public data — TMD, GISTDA, the Pollution Control Department, OpenStreetMap and more — across every system on this page. Messy, scattered data is normal. That is where we start.',
      q3: 'Is our data safe?',
      a3: 'The proof runs on public data, so no sensitive records leave your hands in the first step. Delivery is designed to PDPA and GDPR-informed principles and recognised ISO/IEC frameworks — alignment by practice, not certification (details under Credentials).',
      q4: 'You\'re a small team. Can you deliver?',
      a4: 'You work directly with the two founders who design and build every system — Dr Non Arkaraprasertkul (Harvard PhD; Senior Expert, Smart City Promotion, depa) and Dr Poon Thiengburanathum. No account managers in between. Specialists — UAV operators, traffic engineers, policy translators — join per mission.',
      q5: 'Will it still run after launch?',
      a5: 'Most systems on this page are still live long after their launch press cycle ended. Each one is documented and instrumented so your own team can keep it running.',
      cta: 'Start a two-week proof',
      cta2: 'Open a live system first',
    },
  },
  th: {
    pitch: {
      kicker: 'ปัญหาที่ผมแก้',
      meta: 'สำหรับผู้ว่าฯ · นายกเทศมนตรี · หัวหน้าหน่วยงาน · ผู้ดำเนินการ',
      title: 'น้ำมาตอนตีสอง <em>แดชบอร์ดมาปีงบประมาณหน้า</em>',
      lede: 'คุณมีข้อมูลอยู่แล้ว — เครื่องวัดฝน ปริมาณจราจร เซนเซอร์คุณภาพอากาศ เรื่องร้องเรียน ภาพดาวเทียม แต่ข้อมูลกระจายอยู่ในนับสิบหน่วยงานและพอร์ทัลของผู้ขาย พอวิกฤตมาถึงหรือรัฐมนตรีโทรมา คุณคือคนที่ยืนอยู่ในห้องโดยไม่เห็นภาพ นี่คือปัญหาที่ผมแก้: หน้าจอสดหน้าเดียว สำหรับการตัดสินใจหนึ่งเรื่อง ใช้งานได้ภายในสองสัปดาห์',
      painLabel: 'คุ้น ๆ ไหม?',
      pain1: 'ข้อมูลมีอยู่จริง แต่แยกกันอยู่ตามหน่วยงาน ไฟล์ PDF และสเปรดชีต ไม่มีใครเห็นทั้งเมืองบนหน้าจอเดียว',
      pain2: 'ใบเสนอราคาของผู้ขายใช้เวลาหนึ่งปีกับอีกหนึ่งรอบงบประมาณ — และสิ่งที่ได้คือสไลด์ ไม่ใช่ระบบที่ใช้งานได้',
      pain3: 'เมื่อเกิดเหตุ ชั่วโมงแรกหมดไปกับการโทรถามว่าเกิดอะไรขึ้น แทนที่จะได้ตัดสินใจว่าจะทำอะไร',
      vsLabel: 'ทำไมต้องสตูดิโอบูทีค ไม่ใช่บริษัทใหญ่',
      vsThemTitle: 'บริษัทใหญ่',
      vsThem: 'ผู้บริหารระดับสูงมาปิดดีล แต่คนทำงานจริงคือทีมจูเนียร์ที่คุณไม่เคยเจอ ปัญหาเชิงเทคนิคได้คำตอบเป็นสไลด์ กำหนดการเลื่อน และสุดท้ายคุณต้องมาบริหารผู้ขายแทนที่จะได้บริหารเมือง',
      vsUsTitle: 'Axiom',
      vsUs: 'คนที่มานำเสนอคือคนที่ลงมือสร้าง คุณคุยกับสถาปนิกของระบบ ไม่ใช่พนักงานขาย ผมสร้างทุกอย่างที่ปัญหาต้องการแทนคุณ — และคุณตัดสินจากระบบที่ใช้งานได้จริง ไม่ใช่คำสัญญา',
      serviceLine: 'นี่คือความหมายของ Innovation as a Service: คุณนำปัญหามา ผมออกแบบ สร้าง และดูแลคำตอบแทนคุณ',
      howLabel: 'วิธีการทำงาน · สามขั้นตอน',
      step1title: 'สัปดาห์ที่ 1 — ระบุการตัดสินใจให้ชัด',
      step1body: 'ผมนั่งคุยกับคนที่ต้องตัดสินใจจริง — ผู้ว่าฯ ศูนย์เฝ้าระวังน้ำท่วม การท่าเรือ แล้วร่วมกันระบุการตัดสินใจหนึ่งเรื่องที่ต้องเร็วขึ้น ใครเป็นคนตัดสิน และมีข้อมูลอะไรอยู่แล้วบ้าง',
      step2title: 'สัปดาห์ที่ 2 — วางหน้าจอที่ใช้งานได้จริงไว้ในห้อง',
      step2body: 'ผมสร้างบนข้อมูลที่คุณมีอยู่แล้วบวกกับแหล่งข้อมูลสาธารณะฟรี เริ่มต้นโดยไม่ต้องติดเซนเซอร์หรือซื้อฮาร์ดแวร์ใหม่ คุณได้ตัดสินจากระบบที่รันจริง ไม่ใช่ภาพจำลอง ก่อนที่ใครจะเริ่มทำสไลด์',
      step3title: 'ตั้งแต่วันแรก — วัดผลก่อน แล้วค่อยขยาย',
      step3body: 'ทุกหน้าจอบันทึกว่าใครใช้ และช่วยการตัดสินใจเรื่องใดบ้าง คุณขยายเฉพาะสิ่งที่พิสูจน์แล้วว่ามีคนใช้จริง ไม่มีอะไรถูกขยายเพราะความเชื่อ',
      resultLabel: 'สิ่งที่เปลี่ยน · วัดจากระบบที่รันจริง ไม่ใช่คำสัญญา',
      r1lbl: 'Phuket Ops',
      r1: 'การจราจร ความปลอดภัย และสิ่งแวดล้อมบนหน้าจอเดียว ที่ผู้ว่าฯ อ่านจบใน 30 วินาที',
      r2lbl: 'FloodDash',
      r2: 'ทุกจังหวัดของไทยบนภาพน้ำท่วมภาพเดียว — ข้อมูลสาธารณะ 9 แหล่ง อัปเดตทุก 3–60 นาที',
      r3lbl: 'SLIC Index · ไทเป',
      r3: 'จัดอันดับ 157 เมืองแบบสด — ใช้งานได้จริงบนเวทีภายในคีย์โน้ต 45 นาที',
      r4lbl: 'บันทึกภาคสนาม 01',
      r4: 'ผู้ขายบอกว่าซับซ้อนเกินไป สิบสี่วันต่อมา ระบบที่ใช้งานได้ก็อยู่ในห้องประชุมแล้ว',
      proofLine: 'ระบบที่ใช้งานจริง 38 ระบบใน 5 ประเทศ ไม่ต้องเชื่อคำพูดผม — เปิดระบบใดก็ได้ด้านล่างแล้วลองใช้ดู',
      faqLabel: 'ก่อนที่คุณจะถาม',
      q1: 'แพงไหม?',
      a1: 'ขั้นแรกตั้งใจให้เล็ก: พิสูจน์ผลภายในสองสัปดาห์ บนข้อมูลที่คุณมีอยู่แล้วและข้อมูลสาธารณะฟรี ไม่ต้องซื้อฮาร์ดแวร์ คุณตัดสินใจลงทุนก้อนใหญ่ก็ต่อเมื่อได้เห็นก้อนเล็กใช้งานได้จริงแล้วเท่านั้น',
      q2: 'ใช้กับข้อมูลของเราได้ไหม?',
      a2: 'ใช้กับข้อมูลสาธารณะของไทยอยู่แล้ว — กรมอุตุนิยมวิทยา GISTDA กรมควบคุมมลพิษ OpenStreetMap และอื่น ๆ ในทุกระบบบนหน้านี้ ข้อมูลที่ยุ่งและกระจัดกระจายเป็นเรื่องปกติ ผมเริ่มจากตรงนั้น',
      q3: 'ข้อมูลของเราปลอดภัยไหม?',
      a3: 'ขั้นพิสูจน์ใช้ข้อมูลสาธารณะ ข้อมูลอ่อนไหวจึงไม่ต้องออกจากมือคุณในขั้นแรก การส่งมอบออกแบบตามหลัก PDPA และหลักการที่อิง GDPR รวมถึงกรอบ ISO/IEC ที่ได้รับการยอมรับ — สอดคล้องโดยแนวปฏิบัติ ไม่ใช่การรับรอง (รายละเอียดในหัวข้อหนังสือรับรอง)',
      q4: 'ทีมเล็ก ส่งมอบไหวไหม?',
      a4: 'คุณทำงานตรงกับผู้ก่อตั้งสองคนที่ออกแบบและสร้างทุกระบบ — ดร.นน อัครประเสริฐกุล (ปริญญาเอก Harvard; ผู้เชี่ยวชาญอาวุโส ฝ่ายส่งเสริมเมืองอัจฉริยะ depa) และ Dr Poon Thiengburanathum ไม่มีผู้จัดการบัญชีคั่นกลาง ผู้เชี่ยวชาญเฉพาะทาง — นักบิน UAV วิศวกรจราจร ผู้แปลนโยบาย — เข้ามาร่วมเป็นรายภารกิจ',
      q5: 'หลังเปิดตัวแล้วระบบยังอยู่ไหม?',
      a5: 'ระบบส่วนใหญ่บนหน้านี้ยังใช้งานอยู่ หลังรอบข่าวเปิดตัวจบไปนานแล้ว ทุกระบบมีเอกสารและระบบวัดผล เพื่อให้ทีมของคุณดูแลต่อได้เอง',
      cta: 'เริ่มพิสูจน์ใน 2 สัปดาห์',
      cta2: 'เปิดดูระบบจริงก่อน',
    },
  },
  zh: {
    pitch: {
      kicker: '我们解决的问题',
      meta: '面向府尹 · 市长 · 部门负责人 · 运营方',
      title: '洪水凌晨两点到来。<em>仪表盘下个财年才到。</em>',
      lede: '你早已拥有数据——雨量计、交通流量、空气传感器、投诉热线、卫星过境影像。但它们散落在十几个部门和供应商门户里。于是当危机来临、部长来电时，站在会议室里却看不到全局的人，是你。这就是我们要解决的问题：一块实时屏幕，服务一个决策，两周内运行。',
      painLabel: '是否似曾相识？',
      pain1: '数据是有的，但分散在各部门、PDF 和电子表格里。没有人能在一块屏幕上看到整座城市。',
      pain2: '供应商报价要走一年外加一个预算周期——交付的是一套幻灯片，而不是能用的系统。',
      pain3: '出事时，第一个小时花在打电话问“发生了什么”，而不是决定“该做什么”。',
      vsLabel: '为什么选精品工作室，而不是大公司',
      vsThemTitle: '大公司',
      vsThem: '资深合伙人拿下项目，真正干活的是你从没见过的初级团队。技术难题换来一套幻灯片，工期一拖再拖，最后你在管理供应商，而不是管理城市。',
      vsUsTitle: 'Axiom',
      vsUs: '来提案的人就是动手构建的人。你对话的是系统架构师，而不是销售。问题需要什么，我们就替你构建什么——你评判的是跑起来的系统，而不是承诺。',
      serviceLine: '这就是我们所说的“创新即服务”：你带来问题，我们替你设计、构建并运行答案。',
      howLabel: '运作方式 · 三个步骤',
      step1title: '第 1 周——明确决策。',
      step1body: '我们和真正需要拍板的人坐下来——府尹、防汛值班台、港务局。一起锁定一个必须更快做出的决策、由谁来做，以及已经有哪些数据。',
      step2title: '第 2 周——把能用的屏幕放进会议室。',
      step2body: '我们基于你已有的数据加上免费公共数据源来构建。起步不需要新传感器或新硬件。在任何人开始写汇报材料之前，你评判的是一个在线运行的系统，而不是效果图。',
      step3title: '从第一天起——先度量，再扩展。',
      step3body: '每块屏幕都记录谁在使用、支撑了哪些决策。你只扩展被证明真正有人用的部分。不靠信念扩张。',
      resultLabel: '会发生什么变化 · 来自在线系统的实测，而非承诺',
      r1lbl: 'Phuket Ops',
      r1: '交通、公共安全与环境汇于一屏，府尹 30 秒读完。',
      r2lbl: 'FloodDash',
      r2: '泰国每个府都在同一张洪水图上——9 个公共数据源，每 3–60 分钟刷新。',
      r3lbl: 'SLIC Index · 台北',
      r3: '157 座城市实时排名——在一场 45 分钟的主题演讲中现场跑通。',
      r4lbl: '现场笔记 01',
      r4: '供应商说太复杂。十四天后，可用版本已经摆在会议室里。',
      proofLine: '38 个系统在 5 个国家投入生产。不必相信我们的话——打开下面任意一个，亲自使用。',
      faqLabel: '在你开口之前',
      q1: '贵吗？',
      a1: '第一步刻意做小：用两周时间，基于你已有的数据和免费公共数据做验证，无需购买硬件。只有在亲眼看到小版本跑通之后，你才需要决定是否投入更大的建设。',
      q2: '能用我们的数据吗？',
      a2: '它已经在使用泰国公共数据——TMD、GISTDA、污染控制厅、OpenStreetMap 等——覆盖本页的每一个系统。数据杂乱、分散是常态，那正是我们的起点。',
      q3: '我们的数据安全吗？',
      a3: '验证阶段使用公共数据，敏感记录在第一步无需离开你的手。交付按照 PDPA 与参照 GDPR 的原则，以及公认的 ISO/IEC 框架设计——是实践层面的对齐，而非认证（详见“资质”部分）。',
      q4: '你们团队很小，能交付吗？',
      a4: '你直接与设计并构建每个系统的两位创始人合作——Non Arkaraprasertkul 博士（哈佛博士；depa 智慧城市推广高级专家）与 Poon Thiengburanathum 博士。中间没有客户经理。无人机操作员、交通工程师、政策翻译等专家按任务加入。',
      q5: '上线之后还能继续运行吗？',
      a5: '本页大多数系统在发布宣传期结束很久之后仍在运行。每个系统都有文档和度量，你自己的团队就能维持它运转。',
      cta: '开始两周验证',
      cta2: '先打开一个在线系统',
    },
  },
  ko: {
    pitch: {
      kicker: '우리가 푸는 문제',
      meta: '주지사 · 시장 · 기관장 · 운영자를 위해',
      title: '홍수는 새벽 2시에 옵니다. <em>대시보드는 다음 회계연도에 옵니다.</em>',
      lede: '데이터는 이미 갖고 계십니다 — 우량계, 교통량, 대기 센서, 민원, 위성 영상. 하지만 그것은 십여 개 기관과 벤더 포털에 흩어져 있습니다. 그래서 위기가 닥치거나 장관의 전화가 올 때, 그림 없이 회의실에 서 있는 사람은 바로 당신입니다. 우리가 해결하는 문제는 이것입니다: 하나의 결정을 위한 하나의 실시간 화면, 2주 안에 작동.',
      painLabel: '익숙하신가요?',
      pain1: '데이터는 있지만 기관, PDF, 스프레드시트로 나뉘어 있습니다. 도시 전체를 한 화면에서 보는 사람이 없습니다.',
      pain2: '벤더 견적은 1년과 예산 주기 하나를 잡아먹고 — 결과물은 작동하는 시스템이 아니라 슬라이드입니다.',
      pain3: '문제가 생기면 첫 한 시간은 무엇을 할지 결정하는 대신 무슨 일인지 묻는 전화로 사라집니다.',
      vsLabel: '왜 대기업이 아니라 부티크 스튜디오인가',
      vsThemTitle: '대형 업체',
      vsThem: '시니어 파트너가 계약을 따내고, 실제 일은 한 번도 만나본 적 없는 주니어 팀이 합니다. 기술 문제에 돌아오는 것은 슬라이드이고, 일정은 밀리며, 결국 도시가 아니라 벤더를 관리하게 됩니다.',
      vsUsTitle: 'Axiom',
      vsUs: '제안하는 사람이 곧 만드는 사람입니다. 영업 담당자가 아니라 시스템 설계자와 이야기합니다. 문제에 필요한 것은 무엇이든 대신 만들어 드립니다 — 약속이 아니라 작동하는 시스템으로 판단하십시오.',
      serviceLine: '이것이 우리가 말하는 Innovation as a Service입니다: 문제를 가져오시면, 답을 대신 설계하고, 만들고, 운영합니다.',
      howLabel: '작동 방식 · 세 단계',
      step1title: '1주 차 — 결정을 명확히 합니다.',
      step1body: '실제로 결정해야 하는 사람과 마주 앉습니다 — 주지사, 홍수 상황실, 항만 당국. 더 빨라져야 할 하나의 결정, 결정권자, 이미 존재하는 데이터를 함께 확정합니다.',
      step2title: '2주 차 — 작동하는 화면을 회의실에 올립니다.',
      step2body: '이미 가진 데이터와 무료 공공 데이터로 만듭니다. 시작에 새 센서나 하드웨어는 필요 없습니다. 누구도 발표 자료를 쓰기 전에, 목업이 아닌 실시간 시스템으로 판단하십시오.',
      step3title: '첫날부터 — 측정하고, 그다음 확장합니다.',
      step3body: '모든 화면은 누가 쓰는지, 어떤 결정에 쓰였는지 기록합니다. 실제로 쓰인다고 증명된 것만 확장합니다. 믿음만으로 확장하지 않습니다.',
      resultLabel: '무엇이 바뀌는가 · 약속이 아닌 라이브 시스템에서 측정',
      r1lbl: 'Phuket Ops',
      r1: '교통·치안·환경을 한 화면에 — 주지사가 30초 만에 읽습니다.',
      r2lbl: 'FloodDash',
      r2: '태국 모든 주를 하나의 홍수 그림으로 — 공공 데이터 9개, 3–60분마다 갱신.',
      r3lbl: 'SLIC Index · 타이베이',
      r3: '157개 도시 실시간 순위 — 45분 기조연설 안에 무대에서 작동을 보였습니다.',
      r4lbl: '현장 노트 01',
      r4: '벤더는 너무 복잡하다고 했습니다. 14일 뒤, 작동하는 버전이 회의실에 있었습니다.',
      proofLine: '5개국에서 38개 시스템 운영 중. 우리 말을 믿지 마십시오 — 아래에서 아무 시스템이나 열어 직접 써 보십시오.',
      faqLabel: '묻기 전에 답합니다',
      q1: '비싸지 않나요?',
      a1: '첫 단계는 일부러 작게 잡습니다: 이미 가진 데이터와 무료 공공 데이터로 하는 2주 검증, 하드웨어 구매 없음. 작은 것이 작동하는 것을 본 뒤에야 더 큰 구축을 결정하시면 됩니다.',
      q2: '우리 데이터로도 되나요?',
      a2: '이미 태국 공공 데이터 — TMD, GISTDA, 오염통제국, OpenStreetMap 등 — 로 이 페이지의 모든 시스템이 작동합니다. 지저분하고 흩어진 데이터는 정상입니다. 거기서 시작합니다.',
      q3: '데이터는 안전한가요?',
      a3: '검증 단계는 공공 데이터로 진행되므로, 첫 단계에서 민감한 기록이 밖으로 나갈 일이 없습니다. 납품은 PDPA 및 GDPR 기반 원칙, 공인된 ISO/IEC 프레임워크에 맞춰 설계됩니다 — 인증이 아닌 실무 차원의 정렬입니다(자격 섹션 참조).',
      q4: '팀이 작은데 해낼 수 있나요?',
      a4: '모든 시스템을 설계하고 만드는 두 창업자와 직접 일합니다 — Non Arkaraprasertkul 박사(하버드 박사, depa 스마트시티 진흥 수석 전문가)와 Poon Thiengburanathum 박사. 중간에 영업 담당자가 없습니다. UAV 운영자, 교통 엔지니어, 정책 번역가 등 전문가는 임무별로 합류합니다.',
      q5: '출시 후에도 계속 돌아가나요?',
      a5: '이 페이지의 시스템 대부분은 출시 홍보가 끝난 뒤에도 오랫동안 작동 중입니다. 모든 시스템은 문서화와 계측이 되어 있어 귀 기관 팀이 직접 운영할 수 있습니다.',
      cta: '2주 검증 시작하기',
      cta2: '라이브 시스템 먼저 열어보기',
    },
  },
  ja: {
    pitch: {
      kicker: '私たちが解く問題',
      meta: '知事 · 市長 · 機関の長 · 事業者のために',
      title: '洪水は午前2時に来る。<em>ダッシュボードは来年度に来る。</em>',
      lede: 'データはすでにお持ちです——雨量計、交通量、大気センサー、苦情窓口、衛星画像。しかしそれは十数の機関とベンダーのポータルに散らばっています。だから危機が起き、大臣から電話が来たとき、全体像なしに会議室に立っているのはあなたです。私たちが解くのはこの問題です：ひとつの決定のための、ひとつのライブ画面。2週間で稼働。',
      painLabel: '心当たりはありませんか？',
      pain1: 'データは存在するのに、機関、PDF、スプレッドシートに分かれている。都市全体をひとつの画面で見ている人がいない。',
      pain2: 'ベンダーの見積もりは1年と予算サイクルひとつ分——そして届くのは動くシステムではなくスライド。',
      pain3: '何か起きると、最初の1時間は「何をするか」の決定ではなく「何が起きているか」を尋ねる電話に消える。',
      vsLabel: 'なぜ大手ではなく、ブティック・スタジオなのか',
      vsThemTitle: '大手企業',
      vsThem: 'シニアパートナーが契約を取り、実際の作業は会ったこともないジュニアチームが担う。技術的な課題にはスライドが返ってきて、スケジュールは遅れ、最後には都市ではなくベンダーを管理することになる。',
      vsUsTitle: 'Axiom',
      vsUs: '提案する人が、そのまま作る人です。話す相手は営業ではなく、システムの設計者です。課題が必要とするものは何でも、あなたに代わって構築します——約束ではなく、動くシステムで判断してください。',
      serviceLine: 'これが私たちの言う Innovation as a Service です：課題を持ち込んでいただければ、答えをあなたに代わって設計し、構築し、運用します。',
      howLabel: '進め方 · 3つのステップ',
      step1title: '第1週——決定を特定する。',
      step1body: '実際に決める人と向き合います——知事、洪水対策デスク、港湾当局。速くすべきひとつの決定、決める人、すでにあるデータを一緒に確定します。',
      step2title: '第2週——動く画面を会議室に置く。',
      step2body: 'お手持ちのデータと無料の公共データで構築します。開始時に新しいセンサーやハードウェアは不要です。誰かが資料を書き始める前に、モックアップではなく稼働中のシステムで判断していただけます。',
      step3title: '初日から——測ってから、広げる。',
      step3body: 'すべての画面が、誰が使い、どの決定に関わったかを記録します。実際に使われていると実証されたものだけを拡張します。信念だけで拡大はしません。',
      resultLabel: '何が変わるか · 約束ではなく、稼働中のシステムで測定',
      r1lbl: 'Phuket Ops',
      r1: '交通・治安・環境をひとつの画面に——県知事が30秒で読み取れます。',
      r2lbl: 'FloodDash',
      r2: 'タイ全県をひとつの洪水図に——9つの公共データソース、3〜60分ごとに更新。',
      r3lbl: 'SLIC Index · 台北',
      r3: '157都市をライブでランキング——45分の基調講演の中で、壇上で動かしてみせました。',
      r4lbl: 'フィールドノート 01',
      r4: 'ベンダーは複雑すぎると言った。14日後、動くバージョンが会議室にあった。',
      proofLine: '5か国で38のシステムが本番稼働中。私たちの言葉を信じる必要はありません——下のどれでも開いて、使ってみてください。',
      faqLabel: '聞かれる前に',
      q1: '高くありませんか？',
      a1: '最初の一歩は意図的に小さくしています：お手持ちのデータと無料の公共データによる2週間の実証で、ハードウェア購入は不要です。小さなものが動くのを見てから、より大きな構築を判断してください。',
      q2: '私たちのデータで動きますか？',
      a2: 'すでにタイの公共データ——TMD、GISTDA、公害管理局、OpenStreetMapなど——で、このページのすべてのシステムが動いています。乱雑で散らばったデータは普通のことです。そこから始めます。',
      q3: 'データは安全ですか？',
      a3: '実証段階は公共データで行うため、最初のステップで機密記録が手元を離れることはありません。提供はPDPAおよびGDPRに基づく原則、公認のISO/IECフレームワークに沿って設計しています——認証ではなく、実務上の整合です（詳細は資格セクション）。',
      q4: '小さなチームで対応できますか？',
      a4: 'すべてのシステムを設計・構築する2人の創業者と直接仕事をします——Non Arkaraprasertkul博士（ハーバード大学博士、depaスマートシティ推進シニアエキスパート）とPoon Thiengburanathum博士。間に営業担当はいません。UAVオペレーター、交通エンジニア、政策翻訳者などの専門家はミッションごとに参加します。',
      q5: 'ローンチ後も動き続けますか？',
      a5: 'このページのシステムの多くは、ローンチ時の報道が終わったずっと後も稼働しています。どれも文書化と計測がされており、貴組織のチームが自ら運用を続けられます。',
      cta: '2週間の実証を始める',
      cta2: 'まずライブシステムを開く',
    },
  },
  vi: {
    pitch: {
      kicker: 'Vấn đề chúng tôi giải quyết',
      meta: 'Dành cho tỉnh trưởng · thị trưởng · lãnh đạo cơ quan · đơn vị vận hành',
      title: 'Lũ đến lúc 2 giờ sáng. <em>Dashboard đến vào năm tài khóa sau.</em>',
      lede: 'Bạn đã sở hữu dữ liệu — trạm đo mưa, lưu lượng giao thông, cảm biến không khí, đường dây phản ánh, ảnh vệ tinh. Nhưng chúng nằm ở hàng chục cơ quan và cổng thông tin của nhà cung cấp. Vì vậy khi khủng hoảng ập đến hay bộ trưởng gọi điện, bạn là người đứng trong phòng mà không có bức tranh toàn cảnh. Đó là vấn đề chúng tôi giải quyết: một màn hình trực tiếp, cho một quyết định, chạy được trong hai tuần.',
      painLabel: 'Nghe có quen không?',
      pain1: 'Dữ liệu có đó, nhưng bị chia cắt giữa các cơ quan, file PDF và bảng tính. Không ai nhìn thấy cả thành phố trên một màn hình.',
      pain2: 'Báo giá của nhà cung cấp mất một năm và một chu kỳ ngân sách — và thứ nhận được là bộ slide, không phải hệ thống chạy được.',
      pain3: 'Khi có sự cố, giờ đầu tiên dành cho những cuộc gọi hỏi chuyện gì đang xảy ra, thay vì quyết định phải làm gì.',
      vsLabel: 'Vì sao chọn studio nhỏ chuyên sâu, không phải công ty lớn',
      vsThemTitle: 'Công ty lớn',
      vsThem: 'Một đối tác cấp cao giành được hợp đồng. Một đội ngũ junior bạn chưa từng gặp làm phần việc thật. Bài toán kỹ thuật nhận về một bộ slide, tiến độ trễ, và cuối cùng bạn phải quản lý nhà cung cấp thay vì quản lý thành phố.',
      vsUsTitle: 'Axiom',
      vsUs: 'Người trình bày chính là người xây dựng. Bạn nói chuyện với kiến trúc sư hệ thống, không phải nhân viên bán hàng. Bài toán cần gì, chúng tôi xây thay bạn cái đó — và bạn đánh giá bằng hệ thống chạy được, không phải lời hứa.',
      serviceLine: 'Đó là ý nghĩa của Innovation as a Service: bạn mang đến bài toán, chúng tôi thiết kế, xây dựng và vận hành lời giải thay bạn.',
      howLabel: 'Cách làm việc · ba bước',
      step1title: 'Tuần 1 — Xác định quyết định.',
      step1body: 'Chúng tôi ngồi với người phải ra quyết định — tỉnh trưởng, bàn trực lũ, cảng vụ. Cùng chốt một quyết định cần nhanh hơn, ai quyết định, và dữ liệu nào đã có sẵn.',
      step2title: 'Tuần 2 — Đặt một màn hình chạy được vào phòng họp.',
      step2body: 'Chúng tôi xây dựng trên dữ liệu bạn đã có cùng các nguồn công khai miễn phí. Không cần cảm biến hay phần cứng mới để bắt đầu. Bạn đánh giá một hệ thống đang chạy, không phải bản phác, trước khi ai đó viết bài thuyết trình.',
      step3title: 'Từ ngày đầu — Đo lường, rồi mới mở rộng.',
      step3body: 'Mỗi màn hình ghi lại ai dùng nó và nó chạm tới quyết định nào. Bạn chỉ mở rộng những gì đã được chứng minh là có người dùng. Không mở rộng dựa trên niềm tin.',
      resultLabel: 'Điều gì thay đổi · đo trên hệ thống thật, không phải lời hứa',
      r1lbl: 'Phuket Ops',
      r1: 'Giao thông, an ninh và môi trường trên một màn hình mà tỉnh trưởng đọc trong 30 giây.',
      r2lbl: 'FloodDash',
      r2: 'Mọi tỉnh của Thái Lan trên một bức tranh lũ — 9 nguồn công khai, cập nhật mỗi 3–60 phút.',
      r3lbl: 'SLIC Index · Đài Bắc',
      r3: 'Xếp hạng trực tiếp 157 thành phố — chạy thật trên sân khấu trong một bài keynote 45 phút.',
      r4lbl: 'Ghi chép thực địa 01',
      r4: 'Nhà cung cấp nói quá phức tạp. Mười bốn ngày sau, một phiên bản chạy được đã có trong phòng họp.',
      proofLine: '38 hệ thống đang vận hành tại 5 quốc gia. Đừng chỉ tin lời chúng tôi — hãy mở bất kỳ hệ thống nào bên dưới và dùng thử.',
      faqLabel: 'Trước khi bạn hỏi',
      q1: 'Có đắt không?',
      a1: 'Bước đầu được cố ý làm nhỏ: thử nghiệm hai tuần trên dữ liệu bạn đã có và dữ liệu công khai miễn phí, không phải mua phần cứng. Bạn chỉ cam kết xây dựng lớn hơn sau khi đã thấy phiên bản nhỏ chạy được.',
      q2: 'Có dùng được với dữ liệu của chúng tôi không?',
      a2: 'Nó đã chạy với dữ liệu công khai của Thái Lan — TMD, GISTDA, Cục Kiểm soát Ô nhiễm, OpenStreetMap và nhiều nguồn khác — trên mọi hệ thống ở trang này. Dữ liệu lộn xộn, phân tán là chuyện bình thường. Chúng tôi bắt đầu từ đó.',
      q3: 'Dữ liệu của chúng tôi có an toàn không?',
      a3: 'Giai đoạn thử nghiệm dùng dữ liệu công khai, nên ở bước đầu không có hồ sơ nhạy cảm nào phải rời khỏi tay bạn. Việc triển khai được thiết kế theo PDPA, các nguyên tắc dựa trên GDPR và các khung ISO/IEC được công nhận — tuân thủ trong thực hành, không phải chứng nhận (chi tiết ở mục Hồ sơ pháp lý).',
      q4: 'Đội ngũ nhỏ, có làm nổi không?',
      a4: 'Bạn làm việc trực tiếp với hai nhà sáng lập, những người thiết kế và xây dựng mọi hệ thống — TS. Non Arkaraprasertkul (Tiến sĩ Harvard; Chuyên gia cấp cao về Thúc đẩy Thành phố Thông minh, depa) và TS. Poon Thiengburanathum. Không có nhân viên quản lý khách hàng ở giữa. Chuyên gia — người điều khiển UAV, kỹ sư giao thông, người chuyển ngữ chính sách — tham gia theo từng nhiệm vụ.',
      q5: 'Sau khi ra mắt, hệ thống có còn chạy không?',
      a5: 'Hầu hết hệ thống trên trang này vẫn đang chạy rất lâu sau khi đợt truyền thông ra mắt kết thúc. Mỗi hệ thống đều được lập tài liệu và đo lường để đội ngũ của bạn tự vận hành tiếp.',
      cta: 'Bắt đầu thử nghiệm hai tuần',
      cta2: 'Mở một hệ thống thật trước',
    },
  },
  ts: {
    pitch: {
      kicker: 'problem.solve()',
      meta: '// for: governor | mayor | agencyHead | operator',
      title: 'flood.arrivesAt("02:00") <em>// dashboard.arrivesAt("nextFiscalYear")</em>',
      lede: '// you.own(data): rainGauges + trafficCounts + airSensors + complaints + satellite\n// data.location = agencies[12] + vendorPortals\n// crisis.hits() → you.inRoom({ picture: null })\nfix = oneLiveScreen(oneDecision, { within: "2w" })',
      painLabel: 'soundsFamiliar?: boolean',
      pain1: 'data.split(agencies, PDFs, spreadsheets) // city.onOneScreen === false',
      pain2: 'vendor.quote({ time: "1y + budgetCycle" }) // returns SlideDeck, not System',
      pain3: 'incident.firstHour = phoneCalls("what is happening?") // decisions: 0',
      vsLabel: 'boutique vs bigFirm',
      vsThemTitle: 'class BigFirm',
      vsThem: 'seniorPartner.win(deal)\njuniorTeam.deliver() // you never met them\nresult: SlideDeck; timeline.slip(); you.manage(vendor) // not the city',
      vsUsTitle: 'class Axiom',
      vsUs: 'pitcher === builder // talk to the architect, not sales\nbuild(whateverProblemNeeds, { onBehalfOf: you })\njudge(workingSystem) // not promises',
      serviceLine: 'type InnovationAsAService = (problem) => design + build + run({ onBehalfOf: you })',
      howLabel: 'howItWorks(): Step[3]',
      step1title: 'week(1): name(decision)',
      step1body: 'sitWith(decisionMaker) // governor | floodDesk | portAuthority\npin({ decision, owner, existingData })',
      step2title: 'week(2): room.put(workingScreen)',
      step2body: 'build(existingData + freePublicData) // newHardware: 0\njudge(liveSystem).before(presentation)',
      step3title: 'day(1..∞): measure().then(scale)',
      step3body: 'log({ users, decisionsTouched })\nexpand({ only: provenUse }) // scaleOnFaith: never',
      resultLabel: 'results: Measured[] // not Promised[]',
      r1lbl: 'PhuketOps',
      r1: 'governor.read(transit + safety + environment) // 30s, oneScreen',
      r2lbl: 'FloodDash',
      r2: '{ provinces: 77, publicSources: 9, refresh: "3–60min" }',
      r3lbl: 'SLIC.taipei',
      r3: 'rank({ cities: 157, live: true }) // within keynote(45min)',
      r4lbl: 'fieldNote[01]',
      r4: 'vendor.says("too complex") → workingVersion.inRoom(+14d)',
      proofLine: 'systems.filter(s => s.inProduction).length === 38 // countries: 5\n// verify: open any below',
      faqLabel: 'objections.preempt()',
      q1: 'isExpensive?',
      a1: 'step1 = proof({ weeks: 2, data: owned + freePublic, hardware: 0 })\nbiggerBuild.only({ after: proof.works })',
      q2: 'worksWith(ourData)?',
      a2: 'sources: TMD | GISTDA | PCD | OSM | … // live on every system here\nmessyData.isNormal() → start(here)',
      q3: 'isDataSafe?',
      a3: 'proof.data = public // sensitiveRecords.leave: false\ndesign.to(PDPA, GDPR, ISO/IEC) // alignment, not certification',
      q4: 'smallTeam.canDeliver?',
      a4: 'founders: [DrNon, DrPoon] // design + build, accountManagers: 0\nspecialists.join(perMission) // UAV | traffic | policy',
      q5: 'runsAfterLaunch?',
      a5: 'systems.stillLive({ after: pressCycle }) === true\ndocumented + instrumented → yourTeam.canRun()',
      cta: 'proof.start({ weeks: 2 })',
      cta2: 'systems.openLive()',
    },
  },
};

Object.keys(i18nPitch).forEach(locale => {
