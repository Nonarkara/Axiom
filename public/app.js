  ...
  th: {
    panels: {
      ...
      p09: {
        ...
        w3lbl:'ทำไมไม่มี demo', w3:'Council ถูกฝึกบนบันทึกส่วนตัว การตัดสินใจ บันทึกการประชุม และเสียงของผม เป็นทรัพย์สินโดยความจำเป็น protocol stack ประมาณ 600 บรรทัดของ Python เปิดสาธารณะ ทรัพย์สินทางปัญญาคือ methodology การประสานงาน ไม่ใช่ weights', cta:'v1 · DIY Protocol', cta2:'v2 · Agentic + Executor',
      },
      p10: {
  ...
  zh: {
    panels: {
      ...
      p09: {
        ...
        w3lbl:'为何没有演示', w3:'委员会基于个人日记、决策、会议记录和声音训练。出于必要性而专有。协议栈——约600行Python——是开放的。知识产权是协调方法论，而非权重。', cta:'v1 · DIY 协议', cta2:'v2 · 智能体 + 执行者',
      },
      p10: {
