...
const i18nExt = {
  en: {
    ...
    builtStack: {
      heading:'Built with', meta:'95 tools · 8 layers',
  ...
  th: {
    ...
    builtStack: {
      heading:'สร้างด้วย', meta:'95 เครื่องมือ · 8 ชั้น',
  ...
  ts: {
    ...
    builtStack: {
      heading:'buildStack[]', meta:'// 95 tools, 8 layers',
