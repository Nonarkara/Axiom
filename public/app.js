...
const uiCopy = {
  en: {
    ...
    navCurrent: {
      systems: 'Systems', stages: 'Stages', team: 'Team', press: 'Press', credentials: 'Credentials', cta: 'Work With Us',
    },
    heroCurrent: {
  ...
  th: {
    ...
    navCurrent: {
      systems: 'ระบบ', stages: 'เวที', team: 'ทีม', press: 'สื่อ', credentials: 'หนังสือรับรอง', cta: 'เริ่มงานร่วมกัน',
    },
    heroCurrent: {
  ...
  zh: {
    ...
    navCurrent: {
      systems: '系统', stages: '舞台', team: '团队', press: '媒体', credentials: '资质', cta: '开始合作',
    },
    heroCurrent: {
...
const i18nExt = {
  en: {
    ...
    credentialsSect: {
      kicker:'Credentials & standards',
      eyebrow:'Entity · alignment',
      title:'Registered in Thailand. <em>Built to recognised frameworks.</em>',
      lede:'Axiom X is a legally registered Thai company. Our systems are designed against international digital-twin, AI governance, and privacy frameworks — alignment by practice, not certificate theatre.',
      metaStatus:'ACTIVE',
      metaEntity:'REGISTERED',
      metaJuris:'TH',
  ...
  th: {
    ...
    credentialsSect: {
      kicker:'หนังสือรับรองและมาตรฐาน',
      eyebrow:'นิติบุคคล · การจัดแนว',
      title:'จดทะเบียนในประเทศไทย <em>ออกแบบตามกรอบมาตรฐานที่ยอมรับ</em>',
      lede:'แอคเซี่ยม เอ็กซ์เป็นนิติบุคคลจดทะเบียนถูกต้องในประเทศไทย ระบบของเราออกแบบตามกรอบ digital twin การกำกับดูแล AI และความเป็นส่วนตัวระดับสากล — เป็นการจัดแนวเชิงปฏิบัติ ไม่ใช่การอ้างใบรับรองเพื่อการโฆษณา',
      metaStatus:'ใช้งาน',
      metaEntity:'จดทะเบียนแล้ว',
      metaJuris:'TH',
  ...
  zh: {
    ...
    credentialsSect: {
      kicker:'资质与标准',
      eyebrow:'法人 · 对齐',
      title:'在泰国注册。<em>按公认框架构建。</em>',
      lede:'Axiom X 是在泰国合法注册的公司。我们的系统按国际数字孪生、AI 治理和隐私框架设计——这是实践层面的对齐，不是证书表演。',
      metaStatus:'有效',
      metaEntity:'已注册',
      metaJuris:'TH',
      companyTitle:'注册法人',
  ...
  ts: {
    ...
    credentialsSect: {
      kicker:'// CREDENTIALS_AND_STANDARDS',
      eyebrow:'entity · alignment',
      title:'registered(TH) <em>builtTo(frameworks[])</em>',
      lede:'// AxiomX: legalEntity.registered(TH)\n// systems.designedAgainst({ digitalTwin, aiGov, privacy })\n// alignment: practice // not: certificateTheatre',
      metaStatus:'ACTIVE',
      metaEntity:'REGISTERED',
      metaJuris:'TH',
