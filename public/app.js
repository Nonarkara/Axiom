...
const i18nExt = {
  en: {
    ...
    notesContent: {
      ...
      lede:'Two people. Twelve months. These are the patterns that held — and the ones that didn\'t. Published here because the gap between what governments need and what the market supplies only closes if people share what they\'ve figured out.',
      ...
      n2body:'Every line of code across these systems was written by Claude Code, directed by Dr Non. The AI is the engineer. The human is the architect. This isn\'t a shortcut — it\'s a different model of who does what. Knowing how to direct AI precisely is the skill that compounds. The code is not the hard part.',
    ...
    brandSect: {
      ...
      lede:'Mark, logo system, stationery, cards, presentation, digital, merchandise, environmental — eight sheets. Download the package or browse every sheet.',
  ...
  th: {
    ...
    brandSect: {
      ...
      lede:'เครื่องหมาย ระบบโลโก้ เครื่องเขียน นามบัตร งานนำเสนอ ดิจิทัล ของที่ระลึก ป้ายในพื้นที่ — 8 แผ่น ดาวน์โหลดชุดเต็มหรือเปิดดูทีละแผ่น',
  ...
  zh: {
    ...
    notesContent: {
      ...
      kicker:'怎么搭出来的',
      title:'真做出来才学到的事',
      lede:'两个人 十二个月 这些是坚持下来的模式 以及那些没坚持住的 把它们放在这里 因为政府的需求和市场的供给之间那道缝 只有大家把弄明白的东西分享出来 才能慢慢闭合',
      ...
      n2body:'这些系统每一行代码都是Claude Code写的 由我来指挥 AI是工程师 人是建筑师 这不是捷径 这是一种不同的分工模型 精准地指挥AI的能力是会复利的技能 代码不是难的部分',
    ...
    brandSect: {
      ...
      kicker:'品牌工具包',
      meta:'8 张 · Axiom 识别系统',
      lede:'标志、标志系统、信纸、名片、演示、数字、周边、环境导视——八张规范。下载完整包或逐张浏览。',
      downloadCta:'下载品牌工具包',
      expandAll:'查看全部品牌规范',
    },
  ...
  ts: {
    ...
    brandSect: {
      ...
      lede:'// mark, logoSystem, stationery, cards, deck, digital, merch, environmental — 8 sheets\n// download.zip() || browse.all()',
